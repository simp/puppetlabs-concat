...
## [v6.3.0](https://github.com/puppetlabs/puppetlabs-concat/tree/v6.3.0) (2020-09-04)

[Full Changelog](https://github.com/puppetlabs/puppetlabs-concat/compare/v6.2.0...v6.3.0)

### Added

- pdksync - \(IAC-973\) - Update travis/appveyor to run on new default branch main [\#654](https://github.com/puppetlabs/puppetlabs-concat/pull/654) ([david22swan](https://github.com/david22swan))
